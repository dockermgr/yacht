...
# Defaults
APPNAME="yacht"
APPDIR="$HOME/.local/share/srv/docker/yacht"
DATADIR="$HOME/.local/share/srv/docker/yacht/files"
INSTDIR="$HOME/.local/share/dockermgr/yacht"
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/yacht"
...
SERVER_PORT_OTHER="${SERVER_PORT_OTHER:-15000}"
